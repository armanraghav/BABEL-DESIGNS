          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
            {[
              ...
              <div key={item.author} className="border border-border bg-background p-6">
                <p className="font-serif text-lg italic text-foreground leading-relaxed">"{item.quote}"</p>
      ...
      <section className="section-padding bg-foreground text-primary-foreground section-transition">
        <div className="container-editorial text-center">
          <AnimatedSection>
            ...
            <p className="mx-auto mb-6 max-w-2xl font-sans text-sm uppercase tracking-[0.3em] text-primary-foreground/70">
              Subscribe to Studio Dispatch
            </p>
            <form
              onSubmit={handleSubscribe}
              className="mx-auto mb-8 flex max-w-xl flex-col gap-4 sm:flex-row"
            >
              ...
              <input
                ...
                className="h-12 flex-1 border border-primary-foreground/30 bg-transparent px-4 font-sans text-sm text-primary-foreground placeholder:text-primary-foreground/50 focus:border-primary-foreground focus:outline-none"
              />
              <button
                type="submit"
                data-cursor="Join"
                disabled={isSubmitting}
                className="h-12 border border-primary-foreground/40 px-6 font-sans text-xs uppercase tracking-[0.25em] text-primary-foreground transition-all duration-500 hover:bg-primary-foreground hover:text-foreground disabled:opacity-60"
              >
            ...
            <Link
              to="/consultancy"
              data-cursor="Start"
              className="inline-flex items-center gap-3 font-sans text-sm tracking-widest uppercase text-primary-foreground/80 hover:text-primary-foreground transition-colors"
            >
